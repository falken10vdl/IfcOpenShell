...
6. **Test that you can develop python scripts in VSCode for Belnder**: Create a sample blender python file.
...
11. **Adjust the VSCode Blender extensionst**: We will now make some adjustments to the VSCode Blender extension to ease the reload of the addon.
