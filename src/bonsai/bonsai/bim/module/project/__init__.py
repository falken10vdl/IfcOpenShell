...
classes = (
    ...
    operator.ApplyLinkedElementFilter,
    ...
    operator.EditHeader,
    operator.EditLinkedElementFilter,
    operator.EditProjectLibrary,
    operator.EnableCulling,
    operator.EnableEditingHeader,
    operator.EnableEditingLinkedElementFilter,
    operator.ExportIFC,
    ...
    operator.RegenerateLinkedBlenderObjects,
    operator.ReloadLink,
    ...
    operator.SelectLinkedElementFilter,
    ...
    ui.BIM_PT_links,
    ui.BIM_PT_linked_element_filters,
    ui.BIM_PT_purge,
    ui.BIM_UL_library,
